...
assert manifest["dashboardVersion"] == "0.20.0"
assert manifest["minimumNativeVersion"] == "0.15.0"
...
command_name = "Install-Life-Dashboard-Desktop-v15.command"
command_path = ROOT / command_name
command_path.write_text(content)
command_path.chmod(0o755)

zip_path = ROOT / "Install-Life-Dashboard-Desktop-v15.zip"

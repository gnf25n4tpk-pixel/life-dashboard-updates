...
assert manifest["minimumNativeVersion"] == "0.14.0"
...
command_name = "Install-Life-Dashboard-Desktop-v14.command"
command_path = ROOT / command_name
command_path.write_text(content)
command_path.chmod(0o755)

zip_path = ROOT / "Install-Life-Dashboard-Desktop-v14.zip"
